...
int menor_distancia(ponto origem, ponto destinos[], int numpassageiros)
{
	...
	//atribuimos como menor distancia a distancia entre origem e o primeiro passageiro
...
int main()
{
	...
	ponto coordenadaspassageiros2[3]; // armazena a posição dos passageiros selecionados para a viagem
