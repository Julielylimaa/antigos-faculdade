...
int main (){
	...
	int i = 0;//vai contar quantas vacas foram cadastradas
	int menorm = 1000, maiorm = 0, menort = 1000, maiort = 0; //menor litro e maior litro
	float mediatotal;
	...
	while (N != -1){
		...
		switch (N){
			...
			case 5:
				...
				cout << "Manha: " << menorm << endl;
				cout << "Tarde: " << menort << endl;
