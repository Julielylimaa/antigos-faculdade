...
#view funciona como um JOIN, porem cria uma tabela e facilita 
...
CREATE VIEW qtd_resistores AS (
	SELECT i.qtd 'Querem comprar', e.qtd_disponivel 'Podem Vender' 
    FROM estoque e, itens_solicitacao i
    WHERE e.cod_item = i.cod_item AND i.nome Like 'Resistor%'
);

SELECT * FROM qtd_resistores;